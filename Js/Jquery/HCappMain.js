...
//OutboundPayments
$("#H_OutbndPymnt").click(function(event){
	console.log("OutbndPymnt");
	//Perform ajax call to invetory.php to edit type
	$.ajax({
	   url:"php/Notification.php",
	   method:"GET",
	   data:{H_OutbndPymnt:1},
	   success:function(data){$("#DisplayContent").html(data);console.log(data)},
	   error: function(jqXHR, textStatus, errorThrown) {
			           console.log(textStatus, errorThrown);
			        }
...
//PendingPayment(FOR CREDIT CLIENT ONLY)
$("#H_PndPymnt").click(function(event){
...
//Canceld Payments
$("#H_CncldPymnt").click(function(event){
