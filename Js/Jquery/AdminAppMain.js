...
$(document).delegate("#ConfirmItemDeliverd","click",function(event){
	...
	var PAYMENT_APPROVAL_STATUS=$(this).attr('PAYMENT_APPROVAL_STATUS');
	...
	//Make Ajax call
		...
		$.ajax({
			...
			method:"POST",
			data:{ConfirmItemDeliverd:1,COMPANY_NAME:COMPANY_NAME,PRODUCT_NAME:PRODUCT_NAME,QUANTITY:QUANTITY,UNIT:UNIT,PRICE_PER_UNIT:PRICE_PER_UNIT,PAYMENT_APPROVAL_STATUS:PAYMENT_APPROVAL_STATUS,TOTAL_PRICE:TOTAL_PRICE,FROM_CLIENT:FROM_CLIENT,DELIVERY_STATUS:DELIVERY_STATUS,REMARKS:REMARKS},
...
$(document).delegate("#RejectItemDeliverd","click",function(event){
	...
	//Make Ajax call
		...
		$.ajax({
			url:"php/DeliveryEngine.php",
			method:"POST",
			data:{RejectItemDeliverd:1,COMPANY_NAME:COMPANY_NAME,PRODUCT_NAME:PRODUCT_NAME,PRODUCT_IMAGE:PRODUCT_IMAGE,QUANTITY:QUANTITY,UNIT:UNIT,PRICE_PER_UNIT:PRICE_PER_UNIT,PAYMENT_APPROVAL_STATUS:PAYMENT_APPROVAL_STATUS,TOTAL_PRICE:TOTAL_PRICE,FROM_CLIENT:FROM_CLIENT,DELIVERY_STATUS:DELIVERY_STATUS,REMARKS:REMARKS},
			success:function(data){
				$("#formfeedback").html(data);  
...
/*
 This section deals with all purchase and purchase report
*/
//Strart
...
/*
This part generaye purchase report for category
*/
$(document).delegate("#PurchaseReportBtn","click",function(event){
//$("#SalesReportBtn").click(function(event){
//Checks all sales report
//event.preventDefault();
var val=$("#CategoryPurchaseReport :selected").text();
console.log("functional with value: "+val);

$.ajax({
	   url:"php/PurchaseReport.php",
	   method:"POST",
	   data:{PurchaseReportBtn:1,val:val},
	   success:function(data){
	   console.log("post data: "+val);
	   $("#Result2").html(data);
...
//This is part genrate purchase report by product
$(document).delegate("#PurchaseReportProduct","click",function(event){
    event.preventDefault();
	var val=$("#ProductPurchaseReport :selected").text();
	console.log("functional with value: "+val);

	$.ajax({
	   url:"php/PurchaseReport.php",
	   method:"POST",
	   data:{PurchaseReportProduct:1,val:val},
	   success:function(data){
	   console.log(val);
	   $("#Result2").html(data);
	   console.log("This is the php data: "+data)},
	   error: function(jqXHR, textStatus, errorThrown) {
			           console.log(textStatus, errorThrown);
			        }
...
//This is part genrate weekly purchase report 
$(document).delegate("#SalesReportWeekly","click",function(event){
    event.preventDefault();
	console.log("functional with value: ");
...
//This is part genrate monthly purchase report
...
//This is part genrate total purchase report
...
//This is part rates the supplier
event.preventDefault();
console.log("This is "+Special_Offer);

console.log("AddSpecialOffer");
$.ajax({
	   url:"php/Notification.php",
	   method:"GET",
	   data:{AddSpecialOffer:1},
	   success:function(data){
	   $("#Result2").html(data);
	   console.log(data)},
	   error: function(jqXHR, textStatus, errorThrown) {
...
var Special_Offer;
//Extract text value
$(document).delegate("#Special_Offer","blur",function(event){
	Special_Offer=$(this).val();
	console.log("This is "+Special_Offer);
});
//Send text value to database
$(document).delegate("#ADD_SPECIAL_OFFER","click",function(event){
Special_Offer;
$.ajax({
	   url:"php/Notification.php",
	   method:"POST",
	   data:{ADD_SPECIAL_OFFER:1,Special_Offer:Special_Offer},
	   success:function(data){
	   console.log("This is sent to ajax: "+Special_Offer);
	   console.log("Adding Special Offer");
	   $("#form_feed_back").html(data);
	   console.log(data)},
	   error: function(jqXHR, textStatus, errorThrown) {
			           console.log(textStatus, errorThrown);
			        }
...
//View offer from the database
$(document).delegate("#ADIM_VIEW_SPECIAL_OFFER","click",function(event){
$.ajax({
	   url:"php/Notification.php",
	   method:"POST",
	   data:{ADIM_VIEW_SPECIAL_OFFER:1},
	   success:function(data){
	   $("#form_feed_back").html(data);
	   console.log(data)},
	   error: function(jqXHR, textStatus, errorThrown) {
