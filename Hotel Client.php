...
if(!isset($_SESSION['EMAIL']) || !isset($_SESSION['UID']) || !isset($_SESSION['ROLE'])||$_SESSION['ROLE']!='Hotel')
{

    header("location:http://localhost/pick2get/");
}
...
<div class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li><a class="nav-brand" href="#"><b>LOGGED AS:</b> <?php echo $_SESSION['ROLE']."  <b> USER:</b> ".strtoupper($_SESSION['COMPANY_NAME'])." ACCOUNT TYPE:  ".$accountType;?></a></li>

    </ul>
    <!--right panel content-->
    <ul class="nav navbar-nav navbar-right">
     
     <li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><img src="Asset/icon/Notification Icon 2.png" width="22" height="25">NOTIFICATION</a>
       <ul class="dropdown-menu" style="background:#FFF">
        <div class="panel-info" style='font-size: 11px;'>
         <li><a href="#" id='H_ChckItemsDeliverd'><img src="Asset/icon/Delivery Icon.png"  width="22" height="25">CHECK DELIVERD ITEM</a></li>
         <li><a hrerf="#" id="H_OutbndPymnt"><img src="Asset/icon/Transaction (1).png" width="22" height="25">TRANSACTION HISTORY</a></li>
         <li><a href="#" id='H_PndPymnt'><img src="Asset/icon/pending.png" width="22" height="25">PENDING PAYMENT</a></li>
         <!--<li><a href="#" id='H_CncldPymnt'><img src="Asset/icon/view icon.png" width="22" height="25">CANCELE PAYMENT</a>-->
        </div>
        </ul>
     </li>
     <li><a href="#" id="GoCheckOut" accounttype=<?php echo $accountType;?> class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>CART<!--<span class="badge">0</span>--></a>
   ...
   <div class="row">
       <div class="col-md-1"></div>
           <div class="col-md-2" align="left">
             <!--Copy this to supplier page and system admin-->
                     <div class="nav nav-pills nav-stacked" style='font-size: 11px;'>
                     ...
                     <P></BR></P>
                      <P></BR></P>
             <!--Copy this to supplier page and system admin-->   
                     <div class="nav nav-pills navbar-stacked" style='font-size: 11px;'>
       ...
       <div class="col-md-8">
          <div class="panel panel-info">
            <div class="panel-heading"><b>CLIENT PAGE</b></div>
