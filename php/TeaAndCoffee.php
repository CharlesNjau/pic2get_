...
$getFruitsAndVegie="SELECT * FROM  Products WHERE ITEM_GROUP='Tea/Coffee'" ;
   ...
   while($row = $result->fetch_assoc()) 
    {
        ...
        echo"
            ...
            <td>".$Price."</td>
            <td>
            <input type='button' Image='$Image' id='add' price='$Price' SupplierCategory='$SUPPLIER_CATEGORY' product_name='$product' amount_present='$Available_goods' unit='$unit'  class='btn btn-block' value='AddToCart ' >
            </td>
            <td>
