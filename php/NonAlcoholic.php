...
$getFruitsAndVegie="SELECT * FROM  Products WHERE ITEM_GROUP='Syrups' OR ITEM_GROUP='Appertive'";
   ...
   while($row = $result->fetch_assoc()) 
    {
        ...
        echo"
            ...
            <td>".$Price."</td>
            <td>
            <input type='button'id='add' price='$Price' SupplierCategory='$SUPPLIER_CATEGORY' product_name='$product' amount_present='$Available_goods' unit='$unit'  class='btn btn-block' value='AddToCart ' >
            </td>
            <td>
