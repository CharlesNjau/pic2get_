...
$getFruitsAndVegie="SELECT * FROM  Products WHERE ITEM_GROUP='Dairy Products'" ;
   ...
   while($row = $result->fetch_assoc()) 
    {
        ...
        echo"
            ...
            <td>".$Price."</td>
            <td>
            <input type='button'id='add' Image='$Image' price='$Price' product_name='$product' amount_present='$Available_goods' unit='$unit'  class='btn btn-block' value='AddToCart ' >
            </td>
            <td>
